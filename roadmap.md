...
- [x] Match each Developer Console sub-sector defaults panel to the latest reference.
...
- [ ] Use the two uploaded Core Information files as each sub-sector's selectable generic templates.
