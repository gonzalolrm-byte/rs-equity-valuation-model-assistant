...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <AppHeader />
      <main className="mx-auto max-w-6xl px-5 py-5 sm:py-6">
...
function OptionCard({
  ...
  return (
    <button
      ...
      className={[
        "flex h-full flex-col rounded-2xl border bg-card p-5 text-left shadow-card transition-all",
        selected
    ...
    >
      ...
      <EditableText
        as="h2"
        className="mt-4 font-heading text-xl font-bold leading-snug"
        group="Option title"
      >
        {title}
      </EditableText>
      ...
      <ul
        className={[
          "mt-4 space-y-1.5 rounded-xl p-3",
          listBg,
        ].join(" ")}
      >
